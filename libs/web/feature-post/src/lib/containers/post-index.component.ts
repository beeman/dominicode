...
import { getAuthUser, WebDataAccessAuthService } from '@dominicode/web/data-access-auth'
import { Post, User } from '@dominicode/web/data-access-core'
...
export class PostIndexComponent implements OnInit {
  ...
  constructor(
    public auth: WebDataAccessAuthService,
    public service: WebFeaturePostService,
    private readonly store: Store,
  ) {
    this.author$ = this.store.select(getAuthUser)
  }
