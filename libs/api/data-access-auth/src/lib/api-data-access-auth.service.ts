...
import { ApiFeatureCoreService } from '@dominicode/api/feature-core'
...
export class ApiDataAccessAuthService {
  constructor(
    private readonly data: ApiDataAccessCoreService,
    private readonly core: ApiFeatureCoreService,
