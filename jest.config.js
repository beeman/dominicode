module.exports = {
  projects: [
    ...
    '<rootDir>/libs/api/data-access-post',
    '<rootDir>/libs/api/feature-post',
    '<rootDir>/libs/api/data-access-profile',
    '<rootDir>/libs/api/feature-profile',
    '<rootDir>/libs/api/data-access-comment',
    '<rootDir>/libs/api/feature-comment',
    '<rootDir>/libs/web/data-access-post',
    '<rootDir>/libs/web/feature-post',
    '<rootDir>/libs/web/ui-post',
    '<rootDir>/libs/web/data-access-profile',
    '<rootDir>/libs/web/feature-profile',
    '<rootDir>/libs/web/ui-profile',
  ],
}
